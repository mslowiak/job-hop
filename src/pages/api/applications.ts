...
import { type ApiErrorResponse, CreateApplicationRequestSchema, type CreateApplicationCommand } from "../../types";
...
export const POST: APIRoute = async ({ request, cookies }) => {
  try {
    ...
    if (!validationResult.success) {
      return createErrorResponse(400, "Validation failed. Please check your input data.");
    }
